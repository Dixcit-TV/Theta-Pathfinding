...
Elite::Triangle* Elite::Polygon::GetAdjacentTriangleOnLine(const Triangle* t, const Line& l) const
{
...
const std::vector<const Elite::Triangle*> Elite::Polygon::GetTrianglesFromLineIndex(unsigned int lineIndex) const
{
	...
	{
		if (pT->metaData.IndexLines[0] == int(lineIndex) ||
			pT->metaData.IndexLines[1] == int(lineIndex) ||
			pT->metaData.IndexLines[2] == int(lineIndex))
		{
